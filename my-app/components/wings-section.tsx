...
export function WingsSection() {
  return (
    <section id="wings" data-anchor="wings" className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <h2 id="wings-heading" className="text-4xl md:text-5xl font-bold mb-4 gradient-text select-none">Our Seven Wings</h2>
